        ...
        <section class="our_bakery_area p_100">
            <div class="container">
                <div class="our_bakery_text">
                    <h2>More Than Happy</h2>
                    <h6>"More Than Happy: Where We Create Exquisite Cakes and Treats to Elevate Your
                        Celebrations and Special Occasions with Unforgettable Flavors and Designs."</h6>
                ...
                <div class="row our_bakery_image">
                    <div class="col-md-4 col-6">
                        <img class="img-fluid" src="img/our-bakery/b3.jpg" alt="">
                    </div>
                    <div class="col-md-4 col-6">
                        <img class="img-fluid" src="img/our-bakery/b2.jpg" alt="">
                    </div>
                    <div class="col-md-4 col-6">
                        <img class="img-fluid" src="img/our-bakery/b1.jpg" alt="">
                    </div>
