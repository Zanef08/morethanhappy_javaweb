...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .item .cake_feature_item .cake_img img{
                width: 300px; 
                height: 200px; 
                object-fit: cover; 
            }
            ...
            <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                <ul>
                    <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-thumb="img/home-slider/slider-9.jpg" data-rotate="0" data-saveperformance="off"
                        data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5=""
                        data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="img/home-slider/slider-9.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
        ...
        <section class="welcome_bakery_area">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="main_title">
                                <h2>Welcome to More Than Happy</h2>
                                <p>"More Than Happy: Where We Create Exquisite Cakes and Treats to Elevate Your
                                    Celebrations and Special Occasions with Unforgettable Flavors and Designs."</p>
                            </div>
                            <div class="welcome_left_text">
                                <p>"Your go-to destination for delectable desserts, custom cakes, and sweet delights,
                                    adding joy to your memorable moments with our artisanal creations and unparalleled taste."</p>
                ...
                <div class="cake_feature_inner">
                    ...
                    <!-- Check and display cake list -->
                    <div class="cake_feature_slider owl-carousel">
                        <%
                            List<CakeDTO> listCake = (List<CakeDTO>) request.getAttribute("GET_CAKE");
                        ...
                        <div class="item">
                            <div class="cake_feature_item">
                                <div class="cake_img">
                                    <img src="<%= cake.getImage()%>" alt="Cake Image">
                                </div>
                                <div class="cake_text">
                                    <h4><%= cake.getPrice()%></h4>
                                    ...
                                    <form action="BuyController" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="buy-button" name="action" value="Buy" />
                                        </div>  
                                    </form>
                                </div>
                            </div>
